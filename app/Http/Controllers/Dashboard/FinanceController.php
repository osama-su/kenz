...
class FinanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.finance.index', compact('allUsers', 'users_m', 'suppliers', 'users', 'products', 'companies'));
    }
...
//        dd(compact('totalSales','totalCost','totalShipping','totalExpenses','profit'));
        ...
        return view('dashboard.finance.show', compact('bills', 'totalbills','totalSales', 'totalCost', 'totalShipping', 'totalExpenses', 'profit'));
    }
