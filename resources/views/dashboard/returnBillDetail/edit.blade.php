...
@section('page_header')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <a href="{{route('dashboard.deliveries.edit',['delivery'=>$delivery->id])}}" class="text-muted">تعديل</a>
        </li>
    </ul>
@endsection
@section('content')
    <form action="{{route('dashboard.deliveries.billDetail.update',
['delivery'=>$delivery->id,'billDetail'=>$billDetail->id])}}"
