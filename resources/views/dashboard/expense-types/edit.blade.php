...
@section('page_header')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{route('dashboard.expense-types.index')}}" class="text-muted">المنتجات</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{route('dashboard.expense-types.edit',['expense_type'=>$expenseType->id])}}" class="text-muted">تعديل</a>
        </li>
    </ul>
@endsection
@section('content')
        ...
        <div class="row">
               <form action="{{route('dashboard.expense-types.update',['expense_type'=>$expenseType->id])}}" method="post"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input name="created_by"
                                       value="{{$expenseType->name??old("name")}}"
