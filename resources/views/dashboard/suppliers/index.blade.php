...
@section('page_header')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{route('dashboard.users.index')}}" class="text-muted">المورد</a>
        </li>
    </ul>
@endsection
@section('content')
    <div class="card card-custom">
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">المورد</h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                @can('create_user')
                    <a href="{{route('dashboard.suppliers.create')}}" class="btn btn-primary font-weight-bolder">
                ...
                @foreach($suppliers as $supplier)
                    <tr id="row-{{ $supplier->id }}">
                        ...
                        <td>
                            ...
                            @endcan
                            @can('delete_supplier')
                                <a data-url="{{ route('dashboard.suppliers.destroy',['supplier' => $supplier->id]) }}"
