    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form action="{{route('dashboard.bills.user.store',['bill'=>$bill->id])}}" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="email" type="text"
                                   value="{{$bill->user->email?? old("email") }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="address" type="text"
                                   value="{{$bill->user->address??old("address") }}"
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input name="mobile"
                                   type="text"
                                   value="{{$bill->user->mobile??old('mobile')}}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="notes" type="text"
                                   value="{{$bill->user->notes??old("notes") }}"
        ...
        <div class="col-md-12">
            <!--begin::Card-->
            <form action="{{route('dashboard.billDetail.store',['bill'=>$bill->id])}}" method="post"
        ...
        <div class="col-md-12">
            <!--begin::Card-->
            <form action="{{route('dashboard.billDetail.storePrice',['bill'=>$bill->id])}}" method="post"
                  enctype="multipart/form-data">
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="discount_percentage" type="number"
                                       value="{{ $bill->discount_percentage?? old("discount_percentage") }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input name="delivery_fee" type="number"
                                       value="{{ $bill->company?($bill->company->gov()->where('gov','like','%%'.$bill->user->gov.'%%')->first()->price??0):$bill->delivery_fee}}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="price_after" type="number" readonly
                                       value="{{$bill->price_after?? old("price_after") }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <select name="delivery_status"
                                    ...
                                    <option value="">اختار</option>
                                    <option value="yes" {{$bill->delivery_status=='yes'?'selected':null}}>نعم</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="delivery_receive"
                                    ...
                                    <option value="">اختار</option>
                                    <option value="now" {{$bill->delivery_receive=='now'?'selected':null}}>فوري</option>
                                    <option value="later" {{$bill->delivery_receive=='later'?'selected':null}}>مؤاجل
                                    </option>
                                </select>
                                <span
                                    class="form-text text-danger" style="float: right;">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 date_receive_div @if($bill->delivery_receive!='later') d-none @endif">
                                <label style="float: right;">تاريخ التسليم:
                                    <span class="text-danger">*</span></label>
                                <input name="date_receive" type="date"
                                       value="{{$bill->date_receive??old('date_receive')}}"
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-body">
                    <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                        ...
                        <tbody class="">
                        @foreach($bill->billDetails()->withTrashed()->get() as $billDetail)
                            <tr id="row-{{ $billDetail->id }}"
                                class=" @if($billDetail->deleted_at!=null)table-danger @endif">
                                <td>{{$billDetail->id??'-'}}</td>
                                <td>{{$billDetail->product->name??'-'}}</td>
                                <td>{{$billDetail->color??'-'}}</td>
                                <td>{{$billDetail->size??'-'}}</td>
                                <td>{{$billDetail->model??'-'}}</td>
                                ...
                                <td>
                                    @can('update_bill')
                                        @if($billDetail->deleted_at==null)
                                            ...
                                            <a href="{{route('dashboard.billDetail.edit', ['bill' => $bill->id,'billDetail'=>$billDetail->id])}}"
                                    ...
                                    @can('delete_bill')
                                        @if($billDetail->deleted_at==null)
                                            <a data-url="{{ route('dashboard.billDetail.destroy', ['bill' => $bill->id,'billDetail'=>$billDetail->id]) }}"
                                               data-item-id="{{ $billDetail->id }}"
